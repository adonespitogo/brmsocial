    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn dropdown-toggle" + size + "' data-toggle='dropdown' href='javascript:void(0)'>" +
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                ...
                "<div class='modal-footer'>" +
                  "<a href='javascript:void(0)' class='btn' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  "<a href='javascript:void(0)' class='btn btn-primary' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='javascript:void(0)' class='btn' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                  "<a href='javascript:void(0)' class='btn btn-primary' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='btn dropdown-toggle" + size + "' data-toggle='dropdown' href='javascript:void(0)' tabindex='-1'>" +
