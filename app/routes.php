...
Route::get('register', array('uses' => 'RegisterController@index'));
Route::get('register/facebook', array('uses' => 'RegisterController@registerViaFacebook'));
Route::get('register/twitter', array('uses' => 'RegisterController@registerViaTwitter'));
